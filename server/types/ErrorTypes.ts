export enum ErrorTypes {
  ...
  ERROR_API_KEY_OR_SECRET = 'ERROR_API_KEY_OR_SECRET',
  ...
  MEETING_CONFIG_NOT_FOUND = 'MEETING_CONFIG_NOT_FOUND',
  ...
  INSUFFICIENT_MEMBERSHIP = 'INSUFFICIENT_MEMBERSHIP',
  USER_API_CREDENTIALS_NOT_EXIST = 'USER_API_CREDENTIALS_NOT_EXIST',

  // Metamask authentication errors
