...
export const CHANGE_PROFILE_INFO_REQUESTED = 'CHANGE_PROFILE_INFO_REQUESTED';
export const CHANGE_PROFILE_INFO_SUCCESS = 'CHANGE_PROFILE_INFO_SUCCESS';
export const CHANGE_PROFILE_INFO_FAILED = 'CHANGE_PROFILE_INFO_FAILED';
export const SHOW_PROFILE_PICTURE_FAILED = 'SHOW_PROFILE_PICTURE_FAILED';
export const SHOW_PROFILE_PICTURE_REQUESTED = 'SHOW_PROFILE_PICTURE_REQUESTED';
export const SHOW_PROFILE_PICTURE_SUCCESS = 'SHOW_PROFILE_PICTURE_SUCCESS';
