...
export const GET_ZONE_CATEGORIES_REQUESTED = 'GET_ZONE_CATEGORIES_REQUESTED';
export const GET_ZONE_CATEGORIES_SUCCESS = 'GET_ZONE_CATEGORIES_SUCCESS';
export const GET_ZONE_CATEGORIES_FAILED = 'GET_ZONE_CATEGORIES_FAILED';
