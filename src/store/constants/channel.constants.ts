...
export const CHANGE_CHANNEL_PICTURE_FAILED = 'CHANGE_CHANNEL_PICTURE_FAILED';
export const CHANGE_CHANNEL_PICTURE_REQUESTED =
  'CHANGE_CHANNEL_PICTURE_REQUESTED';
export const CHANGE_CHANNEL_PICTURE_SUCCESS = 'CHANGE_CHANNEL_PICTURE_SUCCESS';
export const CHANGE_CHANNEL_INFO_REQUESTED = 'CHANGE_CHANNEL_INFO_REQUEST';
export const CHANGE_CHANNEL_INFO_SUCCESS = 'CHANGE_CHANNEL_INFO_SUCCESS';
export const CHANGE_CHANNEL_INFO_FAILED = 'CHANGE_CHANNEL_INFO_FAILED';

export const CHANGE_CHANNEL_PERMISSIONS_REQUESTED =
  'CHANGE_CHANNEL_PERMISSIONS_REQUEST';
export const CHANGE_CHANNEL_PERMISSIONS_SUCCESS =
  'CHANGE_CHANNEL_PERMISSIONS_SUCCESS';
export const CHANGE_CHANNEL_PERMISSIONS_FAILED =
